...
echo -e "   Prometheus: ${GREEN}http://localhost/monitoring/prometheus/${NC}"
echo -e "   Grafana: ${GREEN}http://localhost/monitoring/grafana/${NC} (admin/admin)"
echo -e "   Loki: ${GREEN}http://localhost/monitoring/loki/${NC}"
echo -e "   Alertmanager: ${GREEN}http://localhost/monitoring/alertmanager/${NC}"
