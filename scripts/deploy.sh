...
echo -e "   Frontend: ${GREEN}https://localhost${NC} (HTTP redirected to HTTPS)"
echo -e "   Backend API: ${GREEN}https://localhost/api${NC}"
echo -e "   Prometheus: ${GREEN}https://localhost/monitoring/prometheus/${NC}"
echo -e "   Grafana: ${GREEN}https://localhost/monitoring/grafana/${NC} (admin/admin)"
echo -e "   Loki: ${GREEN}https://localhost/monitoring/loki/${NC}"
echo -e "   Alertmanager: ${GREEN}https://localhost/monitoring/alertmanager/${NC}"
